...
For any task past roughly three steps, delegate the exploration and execution to a subagent and
relay only its conclusion. The subagent's reads, searches and reasoning stay in its own context
and never reach this transcript.
